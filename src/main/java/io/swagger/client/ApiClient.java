...
public class ApiClient {
    ...
    private String basePath = "https://ecommerce-checkout-flow-v1.herokuapp.com/v1";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://ecommerce-checkout-flow-v1.herokuapp.com/v1
